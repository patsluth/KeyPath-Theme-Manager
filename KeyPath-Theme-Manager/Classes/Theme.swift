...
public extension Theme
{
	...
	func addingDefaultComponents() -> Self
	{
		...
		self <== ThemeComponent<SFSafariViewController>()
			<-- (\SFSafariViewController.preferredBarTintColor, self.barTintColor)
			<-- (\SFSafariViewController.preferredControlTintColor, self.tintColor)
